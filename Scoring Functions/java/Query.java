...
public class Query {
	...
	public static void main (String[] args) throws IOException {
		...
		if (args.length == 2 && args[0].equalsIgnoreCase("--score") && args[1].equalsIgnoreCase("TF")){
			System.out.println("Writing Okapi TF");
			OkapiTF.calculateOkapiTFScore();
			OkapiTF.write_score_d(); 
		}else if (args.length == 2 && args[0].equalsIgnoreCase("--score") && args[1].equalsIgnoreCase("TF-IDF")){
		...
		}else if (args.length == 2 && args[0].equalsIgnoreCase("--score") && args[1].equalsIgnoreCase("JM")){
			System.out.println("JM");
			Jelinek_Mercer_Smoothing.calculate_Jelinek_Mercer_Smoothing();
			Jelinek_Mercer_Smoothing.write_score_d();
		}else{
